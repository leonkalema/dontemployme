<?php
	...
	if($_GET['a'])
	{
		...
		mysql_query("UPDATE site_payments SET status = 2 WHERE id = '".$id."'");
		
		$url = "../panel_area/payments.php?t=pending";
	...
	if($_GET['r'])
	{
		...
		mysql_query("UPDATE site_payments SET status = 1 WHERE id = '".$id."'");
		
		$url = "../panel_area/payments.php?t=approved";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        <title>www.dontemployme.com:: Manage Payments</title>
                    	...
                    	<tr>
                        	<td>
                            	<table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>		
                                    	<td style="padding-top:10px;">
                                        	<?php require_once("../other_files/inc_payments_cp.php"); ?>
                                        </td>
                                    </tr>
                                    <tr>		
                                    	<td style="padding-top:10px;">
