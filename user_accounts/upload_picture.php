<?php
	...
	$large_image_name = $_SESSION['ssvid']."resized_pic.jpg"; 		// New name of the large image
	$thumb_image_name = $_SESSION['ssvid']."thumbnail_pic.jpg"; 	// New name of the thumbnail image
...
if (isset($_POST["upload"])) { 
	...
	if (strlen($error)==0){
		...
		if (isset($_FILES['image']['name'])){
			...
			copy($thumb_image_location, "../x/".$thumb_image_name);
...
if (isset($_POST["upload_thumbnail"]) && strlen($large_photo_exists)>0) {
	...
	if($_SESSION[''] == 700)
	{
		header("location: ../user_accounts/wanted_persons.php?t=view");	
	}
	else
	{
		header("location: ../user_accounts/hr_employee.php?t=view");	
	}
	exit();
}
...
<head>
	...
	<script type="text/javascript" src="../site_js/jquery.imgareaselect-0.3.min.js"></script>
</head>
<body>
<?php
