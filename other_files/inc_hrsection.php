<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td>
        	<a href="../user_accounts/index.php" class="toplinks" title="DASH BOARD">DASH BOARD</a> <b> :: HR Employee</b> [ <a href="../user_accounts/hr_employee.php?t=add" class="links" title="Add HR Employee">Add HR Employee</a> ] [ <a href="../user_accounts/hr_employee.php?t=view" class="links" title="View HR Employees">View HR Employees</a> ] 
        </td>
	</tr>
	<?php 
                                	...
                                	<div id="page-wrap">
                                		<div id="example-one">
                                            <ul class="nav">
                                                ...
                                                <li class="nav-five last"><a href="#hr">HR Information</a></li>
                                            </ul>
                                            <div class="list-wrap">
                                                <ul id="personal">
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                                    	<tr>
                                                            ...
                                                            <td style="padding-top:10px;">
                                                                <input type="hidden" name="sourceid" id="sourceid" size="50" value = "1" />
                                	...
                                	<table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-top:10px; padding-bottom:30px;">
                                                ...
                                                <input type="submit" value="Add HR Employee">
                                                <?php	
                                                }
                                                ?>
                                            </td>
                    	...
                    	<table border="0" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr class="<?php echo $row; ?>">
                                ...
                                <td align="center" class="tdother">
                                	<a href="../user_accounts/hr_employee.php?edit=<?php echo base64_encode($result['id']); ?>" class="links" title="Edit HR Employee - <?php echo $names; ?>">Edit</a>
                                </td>
                                <td align="center" class="tdother">
                                	<?php
                                    if($result['picture'] != "")
									...
									?>
                                    	<br />
                                    	<a href="../user_accounts/hr_employee.php?editpic=<?php echo base64_encode($result['id']); ?>" class="links" title="Edit picture for - <?php echo $names; ?>">Edit Picture</a>
                                  	<?php
									}
									?>
                                </td>
                                <td class="tdother">
                                	<table border="0" width="100%" cellpadding="0" cellspacing="0">
										<tr>
                                            ...
                                            <td>
												<a class="fancybox fancybox.ajax" href="../other_files/thisemployee.php?i=<?php echo base64_encode($result['id']); ?>" id="links" title="Details of employee - <?php echo $names; ?>"><?php echo $names; ?></a>
                                           	</td>
                                      	</tr>
                                        <tr>
                                ...
                                <td align="center" class="tdother">
									...
									{
									?>
                                	<a href="#" onclick="promptAction('Cancel HR Employee - <?php echo $names; ?>\'s Listing?', '../user_accounts/hr_employee.php?clk=<?php echo base64_encode($result['id']); ?>');" class="links" title="Cancel List HR Employee - <?php echo $names; ?>">Cancel Listing</a>
                                   <?php	
									}
									else
									{
									?>
                                	<a href="../user_accounts/hr_employee.php?task=1&list=<?php echo base64_encode($result['id']); ?>" class="links" title="List HR Employee - <?php echo $names; ?>">List Now</a>
                                   <?php
									}
								   ?>
                                </td>
                                ...
                                <td align="center" class="tdother">
                                	<a href="#" onClick="return promptAction('Delete HR Employee - <?php echo $names; ?>?', '../user_accounts/hr_employee.php?dhr=<?php echo base64_encode($result['id']); ?>');" class="links" title="Delete HR Employee - <?php echo $names; ?>">Delete</a>
                                </td>
                            ...
                            <tr>
                            	<td colspan="7" align="left" style="padding-top:10px">
                                	<b>*</b> HR Employees without pictures will not be displayed on the website
                                </td>
                            </tr>
                        </table>
                    </td>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td style="padding-top:10px;">
						...
						{
						?>
							<b>Edit Picture for HR Employee - </b> <?php echo $names." #".$edit['randomid']; ?>
						<?php	
						}
						else
						{
						?>
							<b>Add Picture for HR Employee</b>
						<?php	
						}
						?>
					</td>
                                	...
                                	<table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-top:10px; padding-bottom:30px;">
                                                ...
                                                <input type="submit" value="Add HR Employee Picture">
                                                <?php	
                                                }
                                                ?>
                                            </td>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td style="padding-top:10px;">
						...
						{
						?>
							<b>List HR Employee - </b> <?php echo $names." #".$edit['randomid']; ?>
						<?php	
						}
						else
						{
						?>
							<b>Cancel List HR Employee - </b> <?php echo $names." #".$edit['randomid']; ?>
						<?php	
						}
						?>
					</td>
                                	...
                                	<table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-top:10px; padding-bottom:30px;">
                                                ...
                                                ?>
                                                <input type="hidden" name="sourceid" id="sourceid" value="2">
                                                <input type="submit" value="Cancel List HR Employee">
                                                <?php	
                                                }
                                                else
                                                {
                                                ?>
                                                <input type="hidden" name="sourceid" id="sourceid" value="1">
                                                <input type="submit" value="List HR Employee">
                                                <?php	
                                                }
                                                ?>
                                            </td>
